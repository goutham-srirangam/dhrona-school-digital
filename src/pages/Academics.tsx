    ...
    <main className="pt-28">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">Nursery to Class IX — English medium, concept-based learning with IIT-JEE/NEET foundation from early grades.</p>
        </div>
      </section>
